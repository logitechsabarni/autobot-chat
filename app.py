...
with st.sidebar:
    ...
    st.write("Built using **Streamlit** and **OpenAI GPT-4o-mini**.")
    st.markdown("---")
...
if user_input:
    ...
    # Try OpenAI API call with retries
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt < max_retries - 1:
                    ...
                    st.error("⚠️ OpenAI API rate limit reached. Please wait a minute and try again.")
                    reply = "Sorry, I’m temporarily unavailable due to API limits."
